...
class personal
{
	...
	public:
		...
		bool isMonthValid(int mt, int yr)
		{                            
		...
		void getpersonaldata()
		{
    		...
    		while(notValid)
			{
        		cout<<"\nPlease Enter Valid Date of birth"<<endl;
...
class professional
{
	...
	public:
		...
		{
			cout<<"\nYour professional data is as follows";
			cout << "\nName of Organization : " << name_of_organization;
			cout << "\nJob Profile: " << job_profile;
			cout << "\nYour Project:" << project<<endl;
		}
};
...
class academic
{
	...
	public:
		...
		{
			cout<<"\nYour academic data is as follows";
			cout << "\nCollege Name: " << college_name;
			cout << "\nBranch :" << branch;
			cout << "\nYear_of_passing:" << year_of_passing;
			cout << "\nCGPA Scored:" << cgpa<<endl;
		}
};
...
int main()
{
	...
	do
	{
		cout << "\nEnter type of data you want to enter and display :" << endl;       // Using Switch case to creates a menu-driven program
