...
import cv2
img=cv2.imread(r"C:\Users\adity\Desktop\Task\thresholding.jpeg",cv2.IMREAD_GRAYSCALE)
...
status = cv2.imwrite(r'C:\Users\adity\Desktop\Task\SS\Thresh.JPG',simple_thresh)
status1 = cv2.imwrite(r'C:\Users\adity\Desktop\Task\SS\Thresh_inv.JPG',simple_thresh1)
