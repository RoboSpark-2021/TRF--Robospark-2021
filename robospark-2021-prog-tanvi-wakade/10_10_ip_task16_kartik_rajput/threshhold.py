...
cv2.imwrite("simple_thresh_inv.png",simple_thresh1)
cv2.imwrite("adapt_mean.png",adaptive_thresh)
cv2.imwrite("adapt_mean_inv.png",adaptive_thresh0)
cv2.imwrite("adapt_guass.png",adaptive_thresh1)
cv2.imwrite("adapt_guass_inv.png",adaptive_thresh2)
